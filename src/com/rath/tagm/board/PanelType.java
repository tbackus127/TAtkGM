...
public enum PanelType {
  ...
  /** The character representation of this panel type. */
  private final char panelChar;
   ...
   */
  private PanelType(final String p, final char c) {
    this.prefix = p;
    this.panelChar = c;
  }
  ...
  /**
   * Gets the panel character.
   * 
   * @return the panel's representation as a char.
   */
  public char getPanelChar() {

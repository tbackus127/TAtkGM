...
public class GameStats {
  ...
  /** The number of normal panel types. */
  private int numPanelTypes;
  ...
  public GameStats(final RuleSet rs) {
    ...
    this.numPanelTypes = rs.getInitialMaxPanelTypes();
  }
  ...
  /**
   * Gets the maximum number of normal panel IDs.
   * 
   * @return an int.
   */
  public int getNumPanelTypes() {

    return this.numPanelTypes;
  }
